...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildFeeDueTile(ThemeProvider theme, int feeDue) { final hasDue = feeDue > 0; final isDark = theme.isDarkMode; return GestureDetector( onTap: () { Navigator.push(context, MaterialPageRoute(builder: (context) => FeeDueScreen(
